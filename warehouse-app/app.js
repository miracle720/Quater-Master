  ...
  list.innerHTML = mine.map(r => {
    ...
    <div class="worker-card" style="flex-direction:column;align-items:stretch;gap:10px">
      ...
      <div style="display:flex;gap:8px">
        <input type="text" id="reply-input-${r.fbKey}" placeholder="Write a reply…" style="flex:1;padding:8px 10px;font-size:13px;border:0.5px solid var(--border2);border-radius:var(--radius);background:var(--bg2);color:var(--text);outline:none">
...
function renderAdminReports() {
  ...
  list.innerHTML = filtered.map(r => {
    ...
    <div class="worker-card" style="flex-direction:column;align-items:stretch;gap:10px">
      ...
      ${reportMessagesThreadHtml(r)}
      <div style="display:flex;gap:8px">
        <input type="text" id="admin-reply-input-${r.fbKey}" placeholder="Reply to ${escHtml(r.workerName)}…" style="flex:1;padding:8px 10px;font-size:13px;border:0.5px solid var(--border2);border-radius:var(--radius);background:var(--bg2);color:var(--text);outline:none">
